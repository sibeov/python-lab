...
# Imports
from src.intEnum.intEnum import SomeEnum, SomeOtherEnum, SomeClassInheritsEnum
...
def test_SomeClassInheritsEnum():
    assert -1 in SomeClassInheritsEnum, "-1 shall be in structure"
